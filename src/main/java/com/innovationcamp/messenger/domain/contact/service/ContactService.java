...
public class ContactService {
    ...
    public List<ContactResponseDto> getAllContact(Long userId) {
        // 사용자id로 연락처 정보 조회
    ...
    public CreateContactResponseDto createContact(Long userId, String contactEmail) {
        ...
        // 새로운 연락처 생성 및 저장
        Contact newContact = new Contact(userRepository.findById(userId).orElseThrow(),
    ...
    //특정 연락처 삭제
    public ContactResponseDto deleteContact(Long userId, String contactEmail) {
        // contactEmail로 해당 사용자 정보 불러오기
        User contactUser = getUserByEmail(contactEmail);
        Long contactId = contactUser.getId();
