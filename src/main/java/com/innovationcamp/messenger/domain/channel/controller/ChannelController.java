...
public class ChannelController {
    ...
    @Operation(summary = "채널 생성", description = "채널 생성 후 사용자를 관리자 권한으로 채널에 등록합니다." + '\n' +'\n'+
    ...
    @Operation(summary = "채널 id를 사용하여 특정 채널의 정보 조회"
            , description = "특정 채널의 정보( content, password 제외 )를 얻을 수 있습니다. 현재 사용자 정보는 사용하지 않습니다."+ '\n' +'\n'+"getChannel(@PathVariable Long channelId)")
    ...
    @Operation(summary = "채널 id를 사용하여 특정 채널 수정"
            , description = "채널 관리자는 채널 이름과 채널 설명을 수정할 수 있습니다. 채널 비밀번호 수정 기능은 없습니다."+ '\n' +'\n' +
    ...
    @Operation(summary = "채널 id를 사용하여 특정 채널 삭제",description = "채널 관리자가 채널에 등록된 사용자들을 모두 추방하고 채널을 삭제합니다.")
